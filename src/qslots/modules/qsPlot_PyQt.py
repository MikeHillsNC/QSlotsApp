...
import qsSimulator as qsp  # for main() test
...
def plot_add_frame(s,ax0, n_agents_max, n_qslots_max, debug=0):
    """adds lines to plot"""
...
def plot_line(line, lw=1, line_color='b', debug=0):
